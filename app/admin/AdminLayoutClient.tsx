...
export default function AdminLayoutClient({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="min-h-screen bg-[#001829] flex">
      ...
      {/* Sidebar */}
      <aside className={`
        fixed top-0 left-0 h-full w-64 bg-[#001220] border-r border-white/5 z-30
      ...
      `}>
        ...
        <div className="px-3 py-4 border-t border-white/5">
          ...
          <Link
            href="/"
            className="flex items-center gap-3 px-3 py-2.5 rounded-xl text-xs text-white/30 hover:text-white/50 transition-all mt-1"
          >
